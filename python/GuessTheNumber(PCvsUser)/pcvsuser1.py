...
for x in numberChoosed:
    if x in repeatedList:
        userNumber = int(input("Este número já foi selecionado anteriormente. Selecione outro: "))
    elif x not in repeatedList:
...
print(f"\nOs números já digitados pelo usuário são: {repeatedList}")
N += 1
